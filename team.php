...
<head>
    ...
    <meta charset="utf-8">
    <title>The Team | Company Name</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-12 text-center">
                    <div class="page-header">
                        <h1>Join Our Team</h1>
                        <h2> We take a slightly different view to most other firms when it comes to the concept of "the team".</span></h2>
                        <p class="lead">We firmly believe that <strong><span class="text-info">The Team is what happens when we work together</span> - US <U>AND</U> YOU.</strong> </p>
                        <p class="lead">We all prosper when we're successful together, that's why we work so hard to build a solid relationship with you and all our other clients. Its the <strong>TEAM ETHOS</strong> that sets us apart from other firms.</p>
                    </div>
                </div>
    ...
    <!-- TEAM SECTION -->
    <section class="altcolor2" id="team">
        <div class="container">
            ...
            <div class="row">
                ...
                <p class="lead text-center">So if you have an urgent question or just a quick query, everyone here is ready and waiting to help you...</p>
                <p class="lead text-center conclusion">&hellip;and that includes the partners of the firm, who you have direct access to whenever you need it.</p>
    ...
    <section id="clinch">
        <div class="container">
            <p class="text-center"><strong>So what are you waiting for?</strong> Call Today and talk to us about how we can make a real difference to your business. Arrange your <span class="text-danger">FREE, No-Obligation Meeting</span> using the form below or call us direct on <span class="text-danger">0123 456 789</span>.</p>
        </div>
    </section>
    <!-- END CLINCH -->
