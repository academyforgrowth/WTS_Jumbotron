...
<head>
    ...
    <meta charset="utf-8">
    <title>Who We Help | Company Name</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Company Name help small business in Location and {module_contentholder,2145690}, offering services to cater for all types of organisations including start-ups, established firms, or firms looking to sell and needing help with exit-planning. Call us on 0123 456 789">
    <!-- INCLUDES -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-12 text-center">
                    <div class="page-header">
                        <h1>Accountants in Location Helping Small Businesses Grow &amp; Reach Their Goals</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-6">
                        ...
                        <ul class="text-danger text-justify">
                            ...
                            <li>£100 to your favourite charity if you do not consider our meeting to be of immense value to you</li>
                        </ul>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-offset-2 col-lg-8">
                            ...
                            <p class="undecided text-center">Remember, you can meet with us for free, with no-obligation to become our client. We'll even donate £100 to your favourite charity if you don't feel that the meeting was worth your while.</p>
                            <p class="undecided text-center">So what have you got to lose? Call us direct on<a href="tel:0123 456 789">0123 456 789</a> OR you can find our contact details <a href="contact-us.html">here</a></p>
                        </div> 
